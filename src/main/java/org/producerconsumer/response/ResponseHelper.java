...
import org.producerconsumer.annotations.Null;
import org.producerconsumer.annotations.ResponseCode;
import org.producerconsumer.annotations.ResponsePolicy;
import org.producerconsumer.annotations.VoidType;
...
public class ResponseHelper {
	...
	public static Response[] getPossiblePrimitiveResponses(Class<?> classDef,HashMap<String, Integer> responsePolicy) {
		...
		if(responsePolicy==null)
			responsePolicy = new HashMap<String,Integer>();
